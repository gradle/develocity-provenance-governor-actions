...
class ApiClient implements Client {
   ...
   * @param enforcementPoint Name of the enforcement point to evaluate against
  ...
  evaluatePolicy(
    ...
    const evalUrl = `${this.baseUrl}${tenant}/packages/${purl.type}${namespacePath}/${purl.name}/${purl.version}/policy-scans/${policyScan}/enforcement-point/${enforcementPoint}`
